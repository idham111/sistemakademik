                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.courses.destroy', $course->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus mata kuliah ini?')" style="border:none; background:transparent; color:red; cursor:pointer; padding:0; font-family: sans-serif; font-size: 1em;">Hapus</button>
                        </form>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="4" style="text-align: center;">Tidak ada data mata kuliah.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
